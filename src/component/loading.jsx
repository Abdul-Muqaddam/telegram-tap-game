...
const Loading =()=>{
    ...
    return(
        ...
        <img src="/src/assets/loading/musk_bro.png" alt="" className="absolute top-[15rem] right-3"  />
        <div className>
        ...
        <div className='text-[#55F9E9] absolute bottom-12 left-[11rem] animate-fallIn'>
