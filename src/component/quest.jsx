    ...
    return (
        ...
        <>
            <div className="bg-custom-improve-picture bg-no-repeat bg-cover bg-center w-[100vw] h-[190vh]">
                ...
                <div className="font-bold text-[white] text-[2.8rem] flex justify-center mt-[2rem]">
                    Earn more coins
                </div>
                <div className="">
                    <div className="text-white ml-[1.2rem] mt-[1rem] text-[1.5rem]">Daily</div>
                        ...
                        <div className="w-[90vw] h-[60vh] rounded-lg flex justify-evenly items-center flex-col ">
                            <div className="w-[80vw] flex flex-col ">
                                <div className="flex">
                                    ...
                                    <div>
                                        <img src="/src/assets/Quests/bag.jpeg" alt="" className="h-[7vh]" />
                                    </div>
                                    <div>
                                        <div className="text-white ml-[1rem] text-[1.4rem] font-bold text-shadow-black">Complete all daily quests</div>
                            ...
                            <div className="w-[80vw] flex flex-col">
                                <div className="flex">
                                    ...
                                    <div>
                                        <img src="/src/assets/Quests/youtube.jpeg" alt="" className="h-[7vh]" />
                                    </div>
                                    <div className="flex justify-between w-[65vw]">
                                        <div>

                                            <div className="text-white ml-[1rem] text-[1.4rem] font-bold text-shadow-black">Watch youtube video</div>
                                            <div className="flex items-center ml-[0.7rem]">

                                                <img src="/src/assets/hero/coin.png" alt="" className="h-[4vh]" />
                                                <div className="text-[white] text-[1.2rem] text-shadow-black">+60,000 </div>
                                            </div>
                                        </div>
                                        <div className="text-[white] text-[2rem]">&gt;</div>
                                    </div>
                                </div>
                                <div className="w-[80vw] h-[0.15vh] my-[0.5rem] bg-[#6f7784]"></div>
                            </div>
                            ...
                            <div className="w-[80vw] flex flex-col">
                                <div className="flex">
                                    ...
                                    <div>
                                        <img src="/src/assets/Quests/tap.jpeg" alt="" className="h-[7vh]" />
                                    </div>
                                    <div className="flex justify-between w-[65vw]">
                                        <div>

                                            <div className="text-white ml-[1rem] text-[1.4rem] font-bold text-shadow-black">Tap 4200 money</div>
                                            <div className="flex items-center ml-[0.7rem]">
                            ...
                            <div className="w-[80vw] flex flex-col">
                                <div className="flex">
                                    ...
                                    <div>
                                        <img src="/src/assets/Quests/skill.jpeg" alt="" className="h-[7vh]" />
                                    </div>
                                    <div className="flex justify-between w-[65vw]">
                                        <div>

                                            <div className="text-white ml-[1rem] text-[1.4rem] font-bold text-shadow-black">Improve 5 different Skills</div>
                                            <div className="flex items-center ml-[0.7rem]">
                    ...
                    <div className="text-white ml-[1.2rem] mt-[1rem] text-[1.5rem] text-shadow-black">Quests To Do</div>
                    <div className="flex items-center flex-col w-[100vw h-[70vh]">
                        <div className=" w-[90vw] h-[60vh] rounded-lg flex justify-evenly items-center flex-col ">
                            <div className="w-[80vw] flex flex-col">
                                <div className="flex">
                                    ...
                                    <div>
                                        <div className="text-white ml-[1rem] text-[1.4rem] font-bold text-shadow-black text-shadow-black">Complete all daily quests</div>
                                        <div className="flex items-center ml-[0.7rem]">
                                    ...
                                    <div className="flex justify-between w-[65vw]">
                                        <div>
                                            ...
                                            <div className="flex items-center ml-[0.7rem]">
                                                ...
                                                <img src="/src/assets/hero/coin.png" alt="" className="h-[4vh] text-shadow-black" />
                    ...
                    <footer className="  border-[#5074d2] h-[9vh] mt-[47rem] flex fixed bottom-0 ">
